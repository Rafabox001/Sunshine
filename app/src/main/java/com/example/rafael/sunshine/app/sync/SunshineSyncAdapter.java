package com.example.rafael.sunshine.app.sync;
...
import com.example.rafael.sunshine.app.MainActivity;
import com.example.rafael.sunshine.app.R;
import com.example.rafael.sunshine.app.Utility;
import com.example.rafael.sunshine.app.data.WeatherContract;
import com.example.rafael.sunshine.app.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, getContext().getResources().getString(R.string.my_api_key))
                    .build();
    ...
    /** Sets the location status into shared preference. This function should not be called
